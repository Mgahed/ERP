<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            @if(auth()->user()->role === 'admin' || auth()->user()->role === 'normal' || auth()->user()->role === 'viewer')
                ...
                <li class="treeview {{Request::is(app()->getLocale().'/returns/*') ? 'active' : ''}}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{Request::is(app()->getLocale().'/returns/make') ? 'active' : ''}}">
                            <a
                                href="{{auth()->user()->role === 'viewer' ? route('all-returns') : route('make-returns')}}"><i class="ti-more"></i>{{__('Return')}}</a>
                        </li>
            ...
            <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{Request::is(app()->getLocale().'/subcategory/view') ? 'active' : ''}}"><a
                                href="{{route('all.sub.category')}}"><i class="ti-more"></i>{{__('All subcategories')}}
                            </a>
                        </li>
                        <li class="{{Request::is(app()->getLocale().'/sub-sub-category/view') ? 'active' : ''}}"><a
                                href="{{route('all.sub.sub.category')}}"><i
                                    class="ti-more"></i>{{__('All sub subcategories')}}</a>
                        </li>
                    </ul>
                </li>
            ...
            @if(auth()->user()->role === 'product')
                <li class="{{Request::is(app()->getLocale().'/product/edit/*') ? 'active' : ''}}{{Request::is(app()->getLocale().'/product/manage') ? 'active' : ''}}">
                    <a
                        href="{{route('manage-product')}}"><i class="ti-more"></i>{{__('Products')}}</a>
                </li>
            @endif
            @if (auth()->user()->role === 'admin')
